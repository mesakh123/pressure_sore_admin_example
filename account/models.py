...
class Hospital(models.Model):
    code = models.CharField(_("code"), max_length=10, unique=True,blank=True)
    name = models.CharField(max_length=128,default='',)
    phone = models.CharField(max_length=128,default='',blank=True,null=True)
    address = models.CharField(max_length=128,default='',blank=True,null=True)
    supervisor = models.CharField(max_length=128,default='',blank=True,null=True)
    supervisor_phone = models.CharField(max_length=128,default='',blank=True,null=True)
...
class Account(models.Model):
    hospital = models.OneToOneField(Hospital,null=True,blank=True,on_delete=models.SET_NULL)
